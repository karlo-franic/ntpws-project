...
if ($_POST['_action_'] == FALSE) {
    ...
    if (is_null($row)) {
        ...
        $query_check  = "INSERT INTO users (first_name, last_name, email, password, country, city, address, date_of_birth)";
        $query_check .= " VALUES ('" . $_POST['firstname'] . "', '" . $_POST['lastname'] . "', '" . $_POST['email'] . "', '" . $pass_hash . "', '" . $_POST['country'] . "', '" . $_POST['city'] . "', '" . $_POST['address'] . "', '" . $_POST['birthday'] . "')";
        $result = @mysqli_query($MySQL, $query_check);
